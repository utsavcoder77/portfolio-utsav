...
function Hero() {
    return (
        <div className="border-b border-neutral-900 pb-4 w-screen lg:mb-35">
            <div className="flex w-full max-w-8xl flex-wrap mx-5">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        <p className="m-2 leading-8 max-w-l py-6 font-light tracking-tighter">{HERO_CONTENT}</p>
                    </div>
                </div>
